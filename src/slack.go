...
func NewSlackReporter(t *toml.Tree) (*SlackReporter, error) {
	var err error
	r := SlackReporter{}
	// Get strings
...
func (r *SlackReporter) Report(devices *Devices, forceReport bool) (sendMsg bool, err error) {
